...
public class WynnlanternClient implements ClientModInitializer {
    ...
    private static final KeyBinding.Category WynnLantern = KeyBinding.Category.create(Identifier.of("wynnlantern", "wynnlantern"));
